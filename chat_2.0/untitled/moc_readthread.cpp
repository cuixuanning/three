...
QT_MOC_LITERAL(3, 20, 8), // "CHATMSG*"
QT_MOC_LITERAL(4, 29, 7), // "chatmsg"
QT_MOC_LITERAL(5, 37, 17), // "Send2SigninWidget"
QT_MOC_LITERAL(6, 55, 4) // "flag"

    },
    "ReadThread\0Send2UI\0\0CHATMSG*\0chatmsg\0"
    "Send2SigninWidget\0flag"
};
...
void ReadThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Send2UI((*reinterpret_cast< CHATMSG*(*)>(_a[1]))); break;
        case 1: _t->Send2SigninWidget((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ReadThread::Send2UI)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ReadThread::Send2SigninWidget)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ReadThread::Send2UI(CHATMSG * _t1)
{
...
// SIGNAL 1
void ReadThread::Send2SigninWidget(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
